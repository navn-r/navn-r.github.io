...
const years = Math.floor(uptime / 31557600000);
const months = Math.floor(uptime / 2629800000 - (years * 12));
const days = Math.floor(uptime / 86400000 - (years * 365.25) - (months * 30.4167));
...
const onLoad = () => {
  document.getElementById("loader").style.cssText += "animation: disappear 1s forwards";
  console.log(loaded);
}
