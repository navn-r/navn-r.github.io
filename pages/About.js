import{LitElement,html,css}from"../node_modules/lit-element/lit-element.js";class About extends LitElement{static get styles(){return css`
      p {
        margin: 0;
      }
    ...
    `}render(){return html`<p>
      ...
      <div class="footer">
          ...
          - Kevin J. Malone<br />
      </div>`}constructor(){super()}}customElements.define("about-page",About);