import{LitElement,html,css}from"../node_modules/lit-element/lit-element.js";class Menu extends LitElement{constructor(){super();this.current="about";document.getElementById(this.current).style.display="block"}static get styles(){return css`
      p {
    ...
    </div>`}}customElements.define("nav-menu",Menu);