import{LitElement,html,css,unsafeCSS}from"../node_modules/lit-element/lit-element.js";class ProjectCard extends LitElement{constructor(){super();this.name="Project";this.codesrc="#";this.demosrc="#";this.hasdemo=!1;this.hasapp=!1}static get styles(){const orgButton=this.hasdemo||this.hasapp?css`1fr 1fr`:css`1fr`;return css`
      .project-container {
