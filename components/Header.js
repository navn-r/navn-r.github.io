import{LitElement,html,css}from"../node_modules/lit-element/lit-element.js";class Header extends LitElement{static get styles(){return css`
      h1 {
        margin: 0;
        padding: 0;
      }
    ...
    </div>`}constructor(){super()}}customElements.define("my-header",Header);